ACCUSATIVE_CASE_QUESTIONS = [
    {
        ...
        "explanation": {
            ...
            "fa": "فعل «читать» (خواندن) برای مفعول مستقیم به حالت مفعولی نیاز دارد. اسامی مؤنث که به «-а» ختم می‌شوند به «-у» تغییر می‌کنند.",
            "ja": "動詞「читать」（読む）は直接目的語に対格を必要とします。-аで終わる女性名詞は-уに変わります。",
            "vi": "Động từ 'читать' (đọc) yêu cầu cách đối cách cho bổ ngữ trực tiếp. Danh từ giống cái kết thúc bằng -а chuyển thành -у.",
            "zh": "动词“читать”（阅读）要求直接宾语使用第四格（对格）。以-а结尾的阴性名词变为-у。"
        }
    },
    {
        "level": "game_ac_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "مفعول مستقیم فعل «любить» (دوست داشتن) از حالت مفعولی استفاده می‌کند. اسامی مؤنث ختم شده به «-а» به «-у» تبدیل می‌شوند.",
            "ja": "動詞「любить」（愛する・好む）の直接目的語は対格になります。-аで終わる女性名詞は-уに変わります。",
            "vi": "Bổ ngữ trực tiếp của động từ 'любить' (yêu/thích) sử dụng cách đối cách. Danh từ giống cái kết thúc bằng -а chuyển thành -у.",
            "zh": "动词“любить”（喜欢）的直接宾语使用第四格。以-а结尾的阴性名词变为-у。"
        }
    },
    {
        "level": "game_ac_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "برای اسامی جاندار جمع، پایانه‌ی حالت مفعولی با حالت اضافه یکسان است (-ей).",
            "ja": "有声名詞の複数形の場合、対格は生格と同じ語尾（-ей）になります。",
            "vi": "Đối với danh từ số nhiều chỉ vật sống, đuôi cách đối cách giống với cách sinh cách (-ей).",
            "zh": "对于有生命复数名词，第四格的词尾与第二格相同（-ей）。"
        }
    },
    {
        "level": "game_ac_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "برای اسامی مذکر غیرجاندار، حالت مفعولی با حالت فاعلی یکسان است.",
            "ja": "無声の男性名詞の場合、対格は主格と同じ形になります。",
            "vi": "Đối với danh từ giống đực không chỉ vật sống, cách đối cách giống với cách danh cách.",
            "zh": "对于无生命阳性名词，第四格的形式与第一格相同。"
        }
    },
    {
        "level": "game_ac_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "مفعول مستقیم «چه چیزی؟»: اسم مؤنث «сказка» در حالت مفعولی «-а» را به «-у» تغییر می‌دهد.",
            "ja": "直接目的語「何を？」：女性名詞「сказка」は対格で-аが-уに変わります。",
            "vi": "Bổ ngữ trực tiếp 'cái gì?': danh từ giống cái 'сказка' đổi -а thành -у ở cách đối cách.",
            "zh": "直接宾语“什么？”：阴性名词“сказка”在第四格中将-а变为-у。"
        }
    },
    {
        "level": "game_ac_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "برای اسامی مذکر جاندار، پایانه‌ی حالت مفعولی همانند حالت اضافه («-а») است.",
            "ja": "有声の男性名詞の場合、対格の語尾は生格と同じ（-а）になります。",
            "vi": "Đối với danh từ giống đực chỉ vật thể sống, đuôi của cách đối cách giống với cách sinh cách (-а).",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "پرسش «کجا؟» (به کجا؟ - Куда?) به حرف اضافه «в/на» و به دنبال آن حالت مفعولی نیاز دارد.",
            "ja": "「どこへ？」（Куда?）という問いには、前置詞「в/на」と対格が必要です。",
            "vi": "Câu hỏi 'Đi đâu?' (Куда?) yêu cầu giới từ 'в/на' theo sau bởi cách đối cách.",
            "zh": "问题“去哪里？”（Куда?）要求使用介词“в/на”后接第四格（对格）。"
        }
    },
    {
        "level": "game_ac_lvl_direction",
        ...
        "explanation": {
            ...
            "fa": "اسامی مؤنث که به «-ь» ختم می‌شوند در حالت مفعولی تغییر نمی‌کنند.",
            "ja": "-ьで終わる女性名詞（第3変化）は、対格で語尾が変化しません。",
            "vi": "Danh từ giống cái kết thúc bằng -ь không thay đổi đuôi ở cách đối cách.",
            "zh": "以-ь结尾的阴性名词在第四格中词尾不发生变化。"
        }
    },
    {
        "level": "game_ac_lvl_direction",
        ...
        "explanation": {
            ...
            "fa": "برای بیان «به مغازه»، از «в» + حالت مفعولی استفاده می‌کنیم (مذکر غیرجاندار تغییر نمی‌کند).",
            "ja": "「店へ」を表現するには、「в」＋対格（無声男性名詞は変化なし）を使います。",
            "vi": "Để diễn đạt 'đến cửa hàng', chúng ta dùng 'в' + cách đối cách (giống đực không sống giữ nguyên).",
            "zh": "为了表达“去商店”，我们使用“в”+ 第四格（无生命阳性名词保持不变）。"
        }
    },
    {
        "level": "game_ac_lvl_direction",
        ...
        "explanation": {
            ...
            "fa": "مقصد روی یک سطح: «на» + حالت مفعولی («стол»).",
            "ja": "表面への目的地：「на」＋対格（стол）。",
            "vi": "Điểm đến trên bề mặt: 'на' + cách đối cách ('стол').",
            "zh": "表示去往某个平面：使用“на”+ 第四格（стол）。"
        }
    },
    {
        "level": "game_ac_lvl_direction",
        ...
        "explanation": {
            ...
            "fa": "اشاره به مقصد (یک شهر): «в» + حالت مفعولی («Москву»).",
            "ja": "都市への目的地を示す場合：「в」＋対格（Москву）。",
            "vi": "Chỉ điểm đến là một thành phố: 'в' + cách đối cách ('Москву').",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "عبارات تکرار زمانی با کلمه «каждый» (هر) در حالت مفعولی استفاده می‌شوند.",
            "ja": "「каждый」（毎〜）を用いた時間の頻度を表す表現は対格で使われます。",
            "vi": "Các cụm từ chỉ tần suất thời gian với 'каждый' (mỗi) được dùng ở cách đối cách.",
            "zh": "带有“каждый”（每个）的时间频率表达方式使用第四格（对格）。"
        }
    },
    {
        "level": "game_ac_lvl_time",
        ...
        "explanation": {
            ...
            "fa": "عبارات زمانی خنثی مانند «каждое утро» در حالت مفعولی без تغییر باقی می‌مانند.",
            "ja": "「каждое утро」のような中性名詞の時間表現は、対格でも形が変わりません。",
            "vi": "Các cụm từ chỉ thời gian giống trung như 'каждое утро' giữ nguyên ở cách đối cách.",
            "zh": "像“каждое утро”这样的中性时间表达方式在第四格中保持不变。"
        }
    },
    {
        "level": "game_ac_lvl_time",
        ...
        "explanation": {
            ...
            "fa": "اسم مؤنث «каждая суббота» در حالت مفعولی به «каждую субботу» تغییر می‌کند.",
            "ja": "女性名詞の「каждая суббота」は対格で「каждую субботу」に変わります。",
            "vi": "Cụm danh từ giống cái 'каждая суббота' chuyển thành 'каждую субботу' ở cách đối cách.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "ساختار «похож на» (شبیه به) حالت مفعولی می‌گیرد. برای اسامی جاندار، این حالت با حالت اضافه یکسان است («соседа»).",
            "ja": "「похож на」（〜に似ている）という構文は対格をとります。有声名詞の場合、生格と同じ形（соседа）になります。",
            "vi": "Cấu trúc 'похож на' (giống với) dùng cách đối cách. Với danh từ chỉ người/vật sống, nó giống với cách sinh cách ('соседа').",
            "zh": "结构“похож на”（像……）要求使用第四格（对格）。对于有生命名词，其形式与第二格相同（соседа）。"
        }
    },
    {
        "level": "game_ac_lvl_similarity",
        ...
        "explanation": {
            ...
            "fa": "صفت‌هایی که اشیاء مؤنث را توصیف می‌کنند در حالت مفعولی به «-ую» ختم می‌شوند.",
            "ja": "対格で女性名詞を修飾する形容詞の語尾は-уюになります。",
            "vi": "Các tính từ bổ nghĩa cho danh từ giống cái ở cách đối cách có đuôi -ую.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "صفت‌ها و اسامی مذکر غیرجاندار در حالت مفعولی مشابه حالت فاعلی هستند.",
            "ja": "無声の男性名詞と形容詞は、対格でも主格と同じ形になります。",
            "vi": "Tính từ và danh từ giống đực không chỉ vật sống ở cách đối cách giống với cách danh cách.",
            "zh": "无生命阳性形容词和名词在第四格中与第一格形式相同。"
        }
    },
    {
        "level": "game_ac_lvl_adjectives",
        ...
        "explanation": {
            ...
            "fa": "برای صفت‌ها و اسامی مؤنث در حالت مفعولی، پایانه‌ها به «-ую/-юю» و «-у/-ю» تغییر می‌کنند.",
            "ja": "対格の女性形容詞と名詞では、語尾が-ую/-ююおよび-у/-юに変わります。",
            "vi": "Đối với tính từ và danh từ giống cái ở cách đối cách, các đuôi chuyển thành -ую/-юю và -у/-ю.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "ضمیر شخصی «она» (او - مؤنث) در حالت مفعولی به «её» تبدیل می‌شود.",
            "ja": "人称代名詞「она」（彼女は）は対格で「её」（彼女を）に変わります。",
            "vi": "Đại từ nhân xưng 'она' (cô ấy) chuyển thành 'её' (cô ấy - tân ngữ) ở cách đối cách.",
            "zh": "人称代词“она”（她）在第四格（对格）中变为“её”。"
        }
    },
    {
        "level": "game_ac_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "ضمیر «я» (من) در حالت مفعولی به «меня» تبدیل می‌شود.",
            "ja": "代名詞「я」（私は）は対格で「меня」（私を）に変わります。",
            "vi": "Đại từ 'я' (tôi) chuyển thành 'меня' (tôi - tân ngữ) ở cách đối cách.",
            "zh": "人称代词“я”（我）在第四格中变为“меня”。"
        }
    }
]
...
PREPOSITIONAL_CASE_QUESTIONS = [
    {
        ...
        "explanation": {
            ...
            "fa": "حالت حرف اضافه‌ای (درباره چه؟) برای اسامی مؤنث که به «-я/-а» ختم می‌شوند به «-е» تغییر می‌کند.",
            "ja": "-я/-аで終わる女性名詞の前置格（〜について）は、語尾が-еに変わります。",
            "vi": "Cách giới cách (về cái gì?) cho danh từ giống cái kết thúc bằng -я/-а chuyển thành -е.",
            "zh": "关于“关于什么”的问题，以-я/-а结尾的阴性名词在第六格（前置格）中变为-е。"
        }
    },
    {
        "level": "game_pc_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "اسامی مؤنث ختم شده به «-а» در حالت حرف اضافه‌ای هنگام صحبت «درباره» چیزی به «-е» تغییر می‌کنند.",
            "ja": "「〜について」話すとき、-аで終わる女性名詞は前置格で-еに変わります。",
            "vi": "Danh từ giống cái kết thúc bằng -а chuyển thành -е ở cách giới cách khi nói 'về' một điều gì đó.",
            "zh": "在谈论“关于”某事时，以-а结尾的阴性名词在第六格中变为-е。"
        }
    },
    {
        "level": "game_pc_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "اسامی که به «-ие» ختم می‌شوند در حالت حرف اضافه‌ای به «-ии» تغییر می‌کنند.",
            "ja": "-иеで終わる名詞は、前置格で語尾が-ииになります。",
            "vi": "Danh từ kết thúc bằng -ие chuyển thành -ии ở cách giới cách.",
            "zh": "以-ие结尾的名词在第六格中变为-ии。"
        }
    },
    {
        "level": "game_pc_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "اسامی جمع در حالت حرف اضافه‌ای معمولاً به «-ах/-ях» ختم می‌شوند.",
            "ja": "前置格の複数名詞は、通常-ах/-яхで終わります。",
            "vi": "Danh từ số nhiều ở cách giới cách thường kết thúc bằng -ах/-ях.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "برای پاسخ به «کجا؟» (Где?)، از حرف اضافه «в» با پایانه حالت حرف اضافه‌ای «-е» استفاده کنید.",
            "ja": "「どこ？」（Где?）に答えるには、前置詞「в」と前置格語尾-еを使います。",
            "vi": "Để trả lời câu hỏi 'Ở đâu?' (Где?), sử dụng giới từ 'в' với đuôi cách giới cách -е.",
            "zh": "回答“在哪儿？”（Где?）时，使用介词“в”加第六格词尾-е。"
        }
    },
    {
        "level": "game_pc_lvl_where",
        ...
        "explanation": {
            ...
            "fa": "اسامی مذکر (شهرها) هنگام اشاره به مکان با «в»، پایانه «-е» می‌گیرند.",
            "ja": "「в」で場所を示す際、男性名詞（都市名など）は語尾に-еを加えます。",
            "vi": "Danh từ giống đực (tên thành phố) thêm đuôi -е khi chỉ vị trí với 'в'.",
            "zh": "使用“в”表示地点时，阳性名词（如城市名）词尾加-е。"
        }
    },
    {
        "level": "game_pc_lvl_where",
        ...
        "explanation": {
            ...
            "fa": "برخی از مکان‌ها مانند «работа» (کار) به جای «в» از حرف اضافه «на» استفاده می‌کنند.",
            "ja": "「работа」（仕事・職場）のような特定の場所では、「в」の代わりに前置詞「на」を使います。",
            "vi": "Một số địa điểm như 'работа' (công việc) sử dụng giới từ 'на' thay vì 'в'.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "برخی از اسامی مذکر هنگام اشاره به مکان در داخل یا روی چیزی، پایانه‌ی «-у» می‌گیرند.",
            "ja": "一部の男性名詞は、中や上にある場所を示す際、語尾が-уになります。",
            "vi": "Một số danh từ giống đực có đuôi -у khi chỉ vị trí bên trong hoặc trên một vật gì đó.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "صفت‌های مؤنث در حالت حرف اضافه‌ای به «-ой» ختم می‌شوند.",
            "ja": "前置格の女性形容詞의 語尾は-ойになります。",
            "vi": "Tính từ giống cái ở cách giới cách kết thúc bằng -ой.",
            "zh": "阴性形容词在第六格中以-ой结尾。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "صفت‌های مذکر در حالت حرف اضافه‌ای به «-ом/-ем» ختم می‌شوند.",
            "ja": "前置格の男性形容詞の語尾は-ом/-емになります。",
            "vi": "Tính từ giống đực ở cách giới cách kết thúc bằng -ом/-ем.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "ضمیر شخصی «ты» (تو) در حالت حرف اضافه‌ای به «тебе» تغییر می‌کند.",
            "ja": "人称代名詞「ты」（君は）は前置格で「тебе」に変わります。",
            "vi": "Đại từ nhân xưng 'ты' (bạn) chuyển thành 'тебе' ở cách giới cách.",
            "zh": "人称代词“ты”（你）在第六格中变为“тебе”。"
        }
    },
    {
        "level": "game_pc_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "ضمیر «я» (من) در حالت حرف اضافه‌ای به «обо мне» تغییر می‌کند.",
            "ja": "代名詞「я」（私は）は前置格で「обо мне」に変わります。",
            "vi": "Đại từ 'я' (tôi) chuyển thành 'обо мне' ở cách giới cách.",
            "zh": "人称代词“я”（我）在第六格中变为“обо мне”。"
        }
    },
    {
        "level": "game_pc_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "ضمیر اشاره «этот» (این) در حالت حرف اضافه‌ای به «этом» تغییر می‌کند.",
            "ja": "指示代名詞「этот」（この）は前置格で「этом」に変わります。",
            "vi": "Đại từ chỉ định 'этот' chuyển thành 'этом' ở cách giới cách.",
            "zh": "指示代词“этот”在第六格中变为“этом”。"
        }
    },
    {
        "level": "game_pc_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "ضمیر ملکی «моя» (مال من) در حالت حرف اضافه‌ای به «моей» تغییر می‌کند.",
            "ja": "所有代名詞「моя」（私の）は前置格で「моей」に変わります。",
            "vi": "Đại từ sở hữu 'моя' (của tôi) chuyển thành 'моей' ở cách giới cách.",
            "zh": "物主代词“моя”在第六格中变为“моей”。"
        }
    }
]
...
DATIVE_CASE_QUESTIONS = [
    {
        ...
        "explanation": {
            ...
            "fa": "فعل «верить» (باور داشتن) به حالت مفعولی غیرمستقیم نیاز دارد. به اسامی مذکر که به حرف بی‌صدا ختم می‌شوند «-у» اضافه می‌شود.",
            "ja": "動詞「верить」（信じる）は与格を必要とします。子音で終わる男性名詞は語尾に-уを加えます。",
            "vi": "Động từ 'верить' (tin tưởng) yêu cầu cách cho. Danh từ giống đực kết thúc bằng phụ âm thêm đuôi -у.",
            "zh": "动词“верить”（相信）要求使用第三格。以辅音结尾的阳性名词词尾加-у。"
        }
    },
    {
        "level": "game_dc_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "فعل «позвонить» (تلفن کردن) حالت مفعولی غیرمستقیم می‌گیرد. پایانه‌ی اسامی جمع به «-ам/-ям» تغییر می‌کند.",
            "ja": "動詞「позвонить」（電話する）は与格をとります。複数名詞の語尾は-ам/-ямに変わります。",
            "vi": "Động từ 'позвонить' (gọi điện) dùng cách cho. Danh từ số nhiều đổi đuôi thành -ам/-ям.",
            "zh": "动词“позвонить”（打电话）要求第三格。复数名词词尾变为-ам/-ям。"
        }
    },
    {
        "level": "game_dc_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "اسامی مؤنث که به «-а» ختم می‌شوند در حالت مفعولی غیرمستقیم به «-е» تغییر می‌کنند.",
            "ja": "-аで終わる女性名詞は、与格で-еに変わります。",
            "vi": "Danh từ giống cái kết thúc bằng -а chuyển thành -е ở cách cho.",
            "zh": "以-а结尾的阴性名词在第三格中变为-е。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "اسم «дочь» (دختر) یک استثنا است؛ در حالت مفعولی غیرمستقیم به «дочери» تبدیل می‌شود.",
            "ja": "名詞「дочь」（娘）は例外で、与格では「дочери」になります。",
            "vi": "Danh từ 'дочь' (con gái) là một trường hợp ngoại lệ; trong cách cho nó trở thành 'дочери'.",
            "zh": "名词“дочь”（女儿）是特殊词，其第三格形式为“дочери”。"
        }
    },
    {
        "level": "game_dc_lvl_exceptions",
        ...
        "explanation": {
            ...
            "fa": "اسم «мать» (مادر) از همان الگوی استثنایی «дочь» پیروی می‌کند و به «матери» تغییر می‌یابد.",
            "ja": "名詞「мать」（母）は「дочь」と同じ例外パターンに従い、「матери」に変わります。",
            "vi": "Danh từ 'мать' (mẹ) tuân theo cùng một quy tắc ngoại lệ như 'дочь', chuyển thành 'матери'.",
            "zh": "名词“мать”（母亲）遵循与“дочь”相同的特殊变化规律，变为“матери”。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "ضمیر شخصی «я» (من) در حالت مفعولی غیرمستقیم به «мне» تغییر می‌کند.",
            "ja": "人称代名詞「я」（私は）は与格で「мне」（私に）に変わります。",
            "vi": "Đại từ nhân xưng 'я' (tôi) chuyển thành 'мне' (cho tôi) ở cách cho.",
            "zh": "人称代词“я”（我）在第三格中变为“мне”。"
        }
    },
    {
        "level": "game_dc_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "ضمیر شخصی «она» (او - مؤنث) در حالت مفعولی غیرمستقیم به «ей» تغییر می‌کند.",
            "ja": "人称代名詞「она」（彼女は）は与格で「ей」（彼女に）に変わります。",
            "vi": "Đại từ nhân xưng 'она' (cô ấy) chuyển thành 'ей' (cho cô ấy) ở cách cho.",
            "zh": "人称代词“она”（她）在第三格中变为“ей”。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "بعد از حرف اضافه «к»، ضمیر اشاره «этоت» (این) پایانه‌ی مفعولی غیرمستقیم مذکر «-ому» را می‌گیرد.",
            "ja": "前置詞「к」の後、指示代名詞「этот」は男性与格語尾の-омуをとります。",
            "vi": "Sau giới từ 'к', đại từ chỉ định 'этот' nhận đuôi cách cho giống đực là -ому.",
            "zh": "在介词“к”之后，指示代词“этот”采用阳性第三格词尾-ому。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "ضمیر ملکی «мой» برای مطابقت با اسم مذکر در حالت مفعولی غیرمستقیم («брату») به «моему» تغییر می‌کند.",
            "ja": "所有代名詞「мой」は、男性与格名詞「брату」に合わせて「моему」に変わります。",
            "vi": "Đại từ sở hữu 'мой' chuyển thành 'моему' để hòa hợp với danh từ giống đực ở cách cho là 'брату'.",
            "zh": "物主代词“мой”变为“моему”，以与阳性第三格名词“брату”一致。"
        }
    },
    {
        "level": "game_dc_lvl_possessives",
        ...
        "explanation": {
            ...
            "fa": "ضمیر ملکی «твой» برای مطابقت با اسم مؤنث در حالت مفعولی غیرمستقیم («сестре») به «твоей» تغییر می‌کند.",
            "ja": "所有代名詞「твой」は、女性与格名詞「сестре」に合わせて「твоей」に変わります。",
            "vi": "Đại từ sở hữu 'твой' chuyển thành 'твоей' để hòa hợp với danh từ giống cái ở cách cho là 'сестре'.",
            "zh": "物主代词“твой”变为“твоей”，以与阴性第三格名词“сестре”一致。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "فعل با فاعل یعنی «фильм» (مذکر مفرد) مطابقت می‌کند. «Мне» در حالت مفعولی غیرمستقیم است.",
            "ja": "動詞は主語の「фильм」（男性単数）に一致します。「Мне」は与格です。",
            "vi": "Động từ hòa hợp với chủ ngữ 'фильм' (giống đực số ít). 'Мне' ở cách cho.",
            "zh": "动词与主语“фильм”（阳性单数）一致。“Мне”使用第三格。"
        }
    },
    {
        "level": "game_dc_lvl_verbs",
        ...
        "explanation": {
            ...
            "fa": "فعل با فاعل جمع یعنی «друзья» مطابقت می‌کند. «Тебе» شکل مفعولی غیرمستقیم «ты» است.",
            "ja": "動詞は複数主語の「друзья」に一致します。「Тебе」は「ты」の与格形です。",
            "vi": "Động từ hòa hợp với chủ ngữ số nhiều 'друзья'. 'Тебе' là dạng cách cho của 'ты'.",
            "zh": "动词与复数主语“друзья”一致。“Тебе”是“ты”的第三格形式。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "در حالت مفعولی غیرمستقیم مذکر مفرد، صفت‌ها پایانه‌ی «-ому» و اسامی پایانه‌ی «-у» می‌گیرند.",
            "ja": "男性単数与格では、形容詞は語尾-ому、名詞は-уをとります。",
            "vi": "Ở cách cho giống đực số ít, tính từ nhận đuôi -ому và danh từ nhận đuôi -у.",
            "zh": "在阳性单数第三格中，形容词词尾为-ому，名词词尾为-у。"
        }
    },
    {
        "level": "game_dc_lvl_adjectives",
        ...
        "explanation": {
            ...
            "fa": "در حالت مفعولی غیرمستقیم مؤنث مفرد، صفت‌ها پایانه‌ی «-ой» و اسامی پایانه‌ی «-е» می‌گیرند.",
            "ja": "女性単数与格では、形容詞は語尾-ой、名詞は-еをとります。",
            "vi": "Ở cách cho giống cái số ít, tính từ nhận đuôi -ой và danh từ nhận đuôi -е.",
            "zh": "在阴性单数第三格中，形容词词尾为-ой，名词词尾为-е。"
        }
    }
]
...
GENITIVE_CASE_QUESTIONS = [
    {
        ...
        "explanation": {
            ...
            "fa": "قید «много» به اضافه جمع نیاز دارد. اسامی مذکر مختوم به حرف بی‌صدا «-ов» می‌گیرند.",
            "ja": "副詞「много」は生格複数を必要とします。子音で終わる男性名詞は-овをとります。",
            "vi": "Trạng từ 'много' yêu cầu cách sinh cách số nhiều. Danh từ giống đực kết thúc bằng phụ âm thêm -ов.",
            "zh": "副词“много”要求复数第二格。以辅音结尾的阳性名词加-ов。"
        }
    },
    {
        "level": "game_gn_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "قید «маلو» به حالت اضافه نیاز دارد. اسامی مؤنث به «-ы» تغییر می‌کنند.",
            "ja": "副詞「мало」は生格を必要とします。-аで終わる女性名詞は-ыに変わります。",
            "vi": "Trạng từ 'мало' yêu cầu cách sinh cách. Danh từ giống cái kết thúc bằng -а đổi thành -ы.",
            "zh": "副词“мало”要求第二格。以-а结尾的阴性名词变为-ы。"
        }
    },
    {
        "level": "game_gn_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "کلمه «несколько» به اضافه جمع نیاز دارد. اسامی مؤنث با «-а» پایان صفر می‌گیرند.",
            "ja": "「несколько」は生格複数を必要とします。-аで終わる女性名詞はゼロ語尾になります。",
            "vi": "Từ 'несколько' yêu cầu sinh cách số nhiều. Danh từ giống cái kết thúc bằng -а có đuôi rỗng.",
            "zh": "单词“несколько”要求复数第二格。以-а结尾的阴性名词为零词尾。"
        }
    },
    {
        "level": "game_gn_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "برای «несколько»، اسامی مؤنث مانند «задача» در حالت اضافه جمع حرف صدادار پایانی را از دست می‌دهند.",
            "ja": "「несколько」の後、女性名詞「задача」などは生格複数学で最後の母音を失います。",
            "vi": "Với 'несколько', danh từ giống cái như 'задача' mất nguyên âm cuối ở sinh cách số nhiều.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "منفی «не было» به حالت اضافه نیاز دارد. صفت‌های خنثی به «-ого» و اسامی به «-я» ختم می‌شوند.",
            "ja": "否定「не было」は生格を必要とします。中性形容詞は-ого、名詞は-яで終わります。",
            "vi": "Phủ định 'не было' yêu cầu sinh cách. Tính từ giống trung kết thúc bằng -ого, danh từ kết thúc bằng -я.",
            "zh": "否定词“не было”要求第二格。中性形容词词尾为-ого，名词为-я。"
        }
    },
    {
        "level": "game_gn_lvl_adjectives",
        ...
        "explanation": {
            ...
            "fa": "«طعم چیزی» از حالت اضافه استفاده می‌کند. صفت‌های مؤنث به «-ей» و اسامی به «-и» ختم می‌شوند.",
            "ja": "「〜の味」は生格を使います。女性形容詞は-ей、名詞は-иで終わります。",
            "vi": "'Hương vị của cái gì' dùng sinh cách. Tính từ giống cái kết thúc bằng -ей, danh từ kết thúc bằng -и.",
            "zh": "“……的味道”使用第二格。阴性形容词词尾为-ей，名词为-и。"
        }
    },
    {
        "level": "game_gn_lvl_adjectives",
        ...
        "explanation": {
            ...
            "fa": "حرف اضافه «без» به حالت اضافه نیاز دارد. «Твой» به «твоего» تغییر می‌کند.",
            "ja": "前置詞「без」は生格を必要とします。「Твой」は「твоего」に変わります。",
            "vi": "Giới từ 'без' yêu cầu sinh cách. 'Твой' đổi thành 'твоего'.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "کلمه «нет» همیشه حالت اضافه را برای اسم و ضمیر آن ایجاد می‌کند.",
            "ja": "「нет」は常に名詞とその代名詞を生格にします。",
            "vi": "Từ 'нет' luôn đi kèm với sinh cách cho danh từ và đại từ.",
            "zh": "单词“нет”总是要求名词及其代词使用第二格。"
        }
    },
    {
        "level": "game_gn_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "بعد از «без»، ضمایر شخصی باید در حالت اضافه باشند. «Ты» به «тебя» تبدیل می‌شود.",
            "ja": "「без」の後、人称代名詞は生格にする必要があります。「Ты」は「тебя」になります。",
            "vi": "Sau 'без', đại từ nhân xưng phải ở sinh cách. 'Ты' đổi thành 'тебя'.",
            "zh": "在“без”之后，人称代词必须使用第二格。“Ты”变为“тебя”。"
        }
    },
    {
        "level": "game_gn_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "ساختار «У + اضافه» نشان‌دهنده مالکیت است. «Вы» به «вас» تغییر می‌کند.",
            "ja": "「У ＋ 生格」の構文は所有を表します。「Вы」は「вас」に変わります。",
            "vi": "Cấu trúc 'У + Sinh cách' chỉ sự sở hữu. 'Вы' đổi thành 'вас'.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "اعداد ۵ و بالاتر به اضافه جمع نیاز دارند. «Друг» به «друзей» تغییر می‌کند.",
            "ja": "5以上の数字は生格複수를必要とします。「Друг」は「друзей」に変わります。",
            "vi": "Số 5 trở lên yêu cầu sinh cách số nhiều. 'Друг' đổi thành 'друзей'.",
            "zh": "数字5及以上要求复数第二格。“Друг”变为“друзей”。"
        }
    },
    {
        "level": "game_gn_lvl_counting",
        ...
        "explanation": {
            ...
            "fa": "اعداد ۲، ۳، ۴ به اضافه مفرد نیاز دارند. «Лекция» به «лекции» تغییر می‌کند.",
            "ja": "数字の2、3、4は生格単数を必要とします。「Лекция」は「лекции」になります。",
            "vi": "Số 2, 3, 4 yêu cầu sinh cách số ít. 'Лекция' đổi thành 'лекции'.",
            "zh": "数字2、3、4要求单数第二格。阴性词“лекция”变为“лекции”。"
        }
    },
    {
        "level": "game_gn_lvl_counting",
        ...
        "explanation": {
            ...
            "fa": "عدد ۳ حالت اضافه مفرد می‌گیرد. به اسم مذکر «магазиن» حرف «-а» اضافه می‌شود.",
            "ja": "数字の3は生格単数をとります。男性名詞「магазин」は-аを加えます。",
            "vi": "Số 3 dùng sinh cách số ít. Danh từ giống đực 'магазин' thêm -а.",
    ...
    },
    {
        ...
        "explanation": {
            ...
            "fa": "هنگام پاسخ به «چه زمانی؟»، عدد ترتیبی روز و سال باید در حالت اضافه باشند.",
            "ja": "「いつ？」と答える場合、日の序数と年は生格にする必要があります。",
            "vi": "Khi trả lời 'Khi nào?', số thứ tự của ngày và năm phải ở sinh cách.",
            "zh": "回答“何时”时，日期的序数词和年份必须使用第二格。"
        }
    }
]
...
INSTRUMENTAL_CASE_QUESTIONS = [
    {
        ...
        "explanation": {
            ...
            "fa": "حرف اضافه «с» (با) به حالت ابزاری نیاز دارد. اسامی مذکر «-ом» می‌گیرند.",
            "ja": "前置詞「с」（〜と）は造格を必要とします。男性名詞は語尾に-омを加えます。",
            "vi": "Giới từ 'с' (với) yêu cầu cách công cụ. Danh từ giống đực thêm đuôi -ом.",
            "zh": "介词“с”（和……一起）要求使用第五格。阳性名词词尾加-ом。"
        }
    },
    {
        "level": "game_it_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "اسامی مؤنث که به «-а» ختم می‌شوند در حالت ابزاری به «-ой» تغییر می‌کنند.",
            "ja": "-аで終わる女性名詞は、造格で-ойに変わります。",
            "vi": "Danh từ giống cái kết thúc bằng -а chuyển thành -ой ở cách công cụ.",
            "zh": "以-а结尾的阴性名词在第五格中变为-ой。"
        }
    },
    {
        "level": "game_it_lvl_nouns",
        ...
        "explanation": {
            ...
            "fa": "اسامی مؤنث نوع سوم صرف (مختوم به «-ь») در حالت ابزاری پایانه‌ی «-ью» می‌گیرند.",
            "ja": "第3変化の女性名詞（-ьで終わるもの）は、造格で語尾が-ьюになります。",
            "vi": "Danh từ giống cái thuộc biến cách thứ 3 (-ь) có đuôi -ью ở cách công cụ.",
            "zh": "第三类变格的阴性名词（以-ь结尾）在第五格中词尾变为-ью。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "فعل «стать» (شدن) برای بیان شغل به حالت ابزاری نیاز دارد.",
            "ja": "動詞「стать」（〜になる）は、職業を表す際に造格を必要とします。",
            "vi": "Động từ 'стать' (trở thành) yêu cầu cách công cụ cho nghề nghiệp.",
            "zh": "动词“стать”（成为）要求职业名使用第五格。"
        }
    },
    {
        "level": "game_it_lvl_verbs",
        ...
        "explanation": {
            ...
            "fa": "اسامی مؤنث مربوط به شغل بعد از فعل «стать» (شدن)، پایانه‌ی «-ой» می‌گیرند.",
            "ja": "「стать」（〜になる）の後の女性の職業名は、語尾が-ойになります。",
            "vi": "Nghề nghiệp giống cái sau 'стать' (trở thành) có đuôi -ой.",
            "zh": "在动词“стать”之后的阴性职业名词尾变为-ой。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "صفت‌های مذکر در حالت ابزاری به «-им/-ым» و اسامی به «-ом» ختم می‌شوند.",
            "ja": "造格の男性形容詞の語尾は-им/-ым、名詞は-омになります。",
            "vi": "Tính từ giống đực ở cách công cụ kết thúc bằng -им/-ым, và danh từ bằng -ом.",
            "zh": "阳性形容词在第五格中以-им/-ым结尾，名词以-ом结尾。"
        }
    },
    {
        "level": "game_it_lvl_adjectives",
        ...
        "explanation": {
            ...
            "fa": "صفت‌های مؤنث در حالت ابزاری پایانه‌ی «-ой» می‌گیرند.",
            "ja": "造格の女性形容詞の語尾は-ойになります。",
            "vi": "Tính từ giống cái ở cách công cụ có đuôi -ой.",
            "zh": "阴性形容词在第五格中词尾变为-ой。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "ضمیر شخصی «она» (او) بعد از حرف اضافه «с» در حالت ابزاری به «ней» تغییر می‌کند.",
            "ja": "人称代名詞「она」は、前置詞「с」の後で造格の「ней」に変わります。",
            "vi": "Đại từ nhân xưng 'она' chuyển thành 'ней' sau giới từ 'с' ở cách công cụ.",
            "zh": "人称代词“она”在介词“с”之后变为第五格形式“ней”。"
        }
    },
    {
        "level": "game_it_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "ضمیر شخصی «ты» (تو) در حالت ابزاری به «тобой» تغییر می‌کند.",
            "ja": "人称代名詞「ты」は、造格で「тобой」に変わります。",
            "vi": "Đại từ nhân xưng 'ты' chuyển thành 'тобой' ở cách công cụ.",
            "zh": "人称代词“ты”在第五格中变为“тобой”。"
        }
    },
    {
        "level": "game_it_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "ضمایر ملکی (мой) در حالت ابزاری مذکر به «-им» ختم می‌شوند.",
            "ja": "男性造格の所有代名詞（мой）は語尾が-имになります。",
            "vi": "Đại từ sở hữu (мой) ở cách công cụ giống đực kết thúc bằng -им.",
            "zh": "物主代词（мой）在阳性第五格中以-им结尾。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "حرف اضافه «под» (زیرِ) برای بیان مکان به حالت ابزاری نیاز دارد.",
            "ja": "場所を示す前置詞「под」（〜の下で）は造格を必要とします。",
            "vi": "Giới từ 'под' (dưới) chỉ vị trí yêu cầu cách công cụ.",
            "zh": "介词“под”（在……下面）表示地点时要求使用第五格。"
        }
    },
    {
        "level": "game_it_lvl_prepositions",
        ...
        "explanation": {
            ...
            "fa": "حرف اضافه «перед» (جلویِ/پیشِ) به حالت ابزاری نیاز دارد.",
            "ja": "前置詞「перед」（〜の前で）は造格を必要とします。",
            "vi": "Giới từ 'перед' (trước) yêu cầu cách công cụ.",
            "zh": "介词“перед”（在……前面）要求使用第五格。"
        }
    },
    {
        "level": "game_it_lvl_prepositions",
        ...
        "explanation": {
            ...
            "fa": "حرف اضافه «над» (بالایِ) حالت ابزاری می‌گیرد. صفت‌های جمع به «-ыми/-ими» ختم می‌شوند.",
            "ja": "前置詞「над」（〜の上空を）は造格をとります。複数形容詞の語尾は-ыми/-имиになります。",
            "vi": "Giới từ 'над' (trên) dùng cách công cụ. Tính từ số nhiều kết thúc bằng -ыми/-ими.",
            "zh": "介词“над”（在……上方）要求使用第五格。复数形容词词尾为-ыми/-ими。"
        }
    },
    {
        "level": "game_it_lvl_prepositions",
        ...
        "explanation": {
            ...
            "fa": "حرف اضافه «за» (پشتِ) برای بیان مکان به حالت ابزاری نیاز دارد.",
            "ja": "場所を示す前置詞「за」（〜の後ろで）は造格を必要とします。",
            "vi": "Giới từ 'за' (sau) chỉ vị trí yêu cầu cách công cụ.",
            "zh": "表示地点的介词“за”（在……后面）要求使用第五格。"
        }
    }
]
...
NOMINATIVE_CASE_QUESTIONS = [
    {
        ...
        "explanation": {
            ...
            "fa": "حالت فاعلی (Nominative) شکل لغت‌نامه‌ای اسم است. برای نهاد جمله یا شناسایی افراد استفاده می‌شود.",
            "ja": "主格は名詞の辞書形です。文の主語や、誰かを紹介する際に使われます。",
            "vi": "Cách danh cách là dạng từ điển của danh từ. Nó được dùng làm chủ ngữ trong câu hoặc để nhận diện ai đó.",
            "zh": "第一格（主格）是名词的词典形式。用于句子主语或辨认某人。"
        }
    },
    {
        "level": "game_nm_lvl_basics",
        ...
        "explanation": {
            ...
            "fa": "در ساختار «Это + اسم»، اسم همیشه در حالت فاعلی قرار می‌گیرد.",
            "ja": "「Это ＋ 名詞」の構文では、名詞は常に主格になります。",
            "vi": "Trong cấu trúc 'Это + danh từ', danh từ luôn ở cách danh cách.",
            "zh": "在“Это + 名词”结构中，名词总是使用第一格。"
        }
    },
    {
        "level": "game_nm_lvl_basics",
        ...
        "explanation": {
            ...
            "fa": "هنگام بیان شغل یک فرد в زمان حال، از حالت فاعلی استفاده می‌شود.",
            "ja": "現在形で職業を述べる場合、主格が使われます。",
            "vi": "Khi xác định nghề nghiệp của một người ở thì hiện tại, cách danh cách được sử dụng.",
            "zh": "在现在时中定义一个人的职业时，使用第一格。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "صفت باید با جنسیت اسم مطابقت داشته باشد. «Картина» مؤنث است، بنابراین پایانه‌ی آن «-ая» است.",
            "ja": "形容詞は名詞の性に一致させる必要があります。「Картина」は女性名詞なので、語尾は-аяになります。",
            "vi": "Tính từ phải hòa hợp với giống của danh từ. 'Картина' là giống cái, nên đuôi là -ая.",
            "zh": "形容词必须与名词的性保持一致。“Картина”是阴性，所以词尾是-ая。"
        }
    },
    {
        "level": "game_nm_lvl_adjectives",
        ...
        "explanation": {
            ...
            "fa": "اسم «море» خنثی است. صفت‌های خنثی در حالت فاعلی معمولاً به «-ое» یا «-ее» ختم می‌شوند.",
            "ja": "名詞「море」は中性です。主格の中性形容詞は通常-оеまたは-ееで終わります。",
            "vi": "Danh từ 'море' là giống trung. Tính từ giống trung ở cách danh cách thường kết thúc bằng -ое hoặc -ее.",
            "zh": "名词“море”是中性。第一格中的中性形容词通常以-ое或-ее结尾。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "برای ساخت جمع اسامی مؤنث ختم شده به «-а»، حرف «-а» را با «-и» جایگزین می‌کنیم.",
            "ja": "-аで終わる女性名詞の複数形を作るには、-аを-иに置き換えます。",
            "vi": "Để tạo số nhiều cho danh từ giống cái kết thúc bằng -а, chúng ta thay -а bằng -и.",
            "zh": "为了变以-а结尾的阴性名词复数，我们将-а替换为-и。"
        }
    },
    {
        "level": "game_nm_lvl_plural",
        ...
        "explanation": {
            ...
            "fa": "برخی از اسامی مذکر دارای جمع بی‌قاعده با پایانه‌ی «-а» (مؤکد) هستند.",
            "ja": "一部の男性名詞は、不規則な複数形語尾-а（アクセントあり）をとります。",
            "vi": "Một số danh từ giống đực có dạng số nhiều bất quy tắc kết thúc bằng -а (có trọng âm).",
            "zh": "一些阳性名词的复数形式不规则，以-а（重读）结尾。"
        }
    },
    {
        "level": "game_nm_lvl_plural",
        ...
        "explanation": {
            ...
            "fa": "اسم «ребёнок» (کودک) برای شکل جمع خود کلمه‌ای کاملاً متفاوت دارد: «дети».",
            "ja": "名詞「ребёнок」（子供）の複数形は、全く別の単語「дети」になります。",
            "vi": "Danh từ 'ребёнок' (đứa trẻ) có một từ hoàn toàn khác cho dạng số nhiều: 'дети'.",
            "zh": "名词“ребёнок”（孩子）的复数形式是一个完全不同的单词：“дети”。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "نهاد جمله (کسی که فعل را انجام می‌دهد) باید в حالت فاعلی باشد.",
            "ja": "文の主語（動作主）は主格にする必要があります。",
            "vi": "Chủ ngữ của câu (người thực hiện hành động) phải ở cách danh cách.",
            "zh": "句子的主语（动作发出者）必须使用第一格。"
        }
    },
    {
        "level": "game_nm_lvl_pronouns",
        ...
        "explanation": {
            ...
            "fa": "برای جایگزینی یک نهاد مذکر (Anton)، از ضمیر فاعلی «он» استفاده می‌کنیم.",
            "ja": "男性の主語（Anton）を置き換えるには、主格代名詞の「он」を使います。",
            "vi": "Để thay thế một chủ ngữ giống đực (Anton), chúng ta dùng đại từ danh cách 'он'.",
            "zh": "为了代指阳性主语（Anton），我们使用第一格代词“он”。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "کلمه پرسشی «что» (چه چیزی) در حالت فاعلی برای نهادهای غیرجاندار استفاده می‌شود.",
            "ja": "無生物の主語に対しては、疑問詞「что」（何が）の主格を使います。",
            "vi": "Từ để hỏi 'что' (cái gì) được dùng ở cách danh cách cho chủ ngữ vô tri.",
            "zh": "疑问词“что”（什么）用于无生命主语的第一格。"
        }
    },
    {
        "level": "game_nm_lvl_questions",
        ...
        "explanation": {
            ...
            "fa": "کلمه پرسشی «кто» (چه کسی) в حالت فاعلی برای نهادهای جاندار استفاده می‌شود.",
            "ja": "有生物の主語に対しては、疑問詞「кто」（誰が）の主格を使います。",
            "vi": "Từ để hỏi 'кто' (ai) được dùng ở cách danh cách cho chủ ngữ chỉ người/vật sống.",
            "zh": "疑问词“кто”（谁）用于有生命主语的第一格。"
        }
    },
    {
        ...
        "explanation": {
            ...
            "fa": "شکل جمع «родители» در اینجا نهاد است، بنابراین در حالت فاعلی باقی می‌ماند.",
            "ja": "ここでの複数形「родители」は主語なので、主格のままです。",
            "vi": "Dạng số nhiều 'родители' là chủ ngữ ở đây, nên nó giữ nguyên ở cách danh cách.",
            "zh": "这里的复数形式“родители”是主语，所以它保持为第一格。"
        }
    },
    {
        "level": "game_nm_lvl_advanced",
        ...
        "explanation": {
            ...
            "fa": "کلمه «здание» به «-ие» ختم می‌شود، به این معنی که خنثی است. صفت باید خنثی باشد («новое»).",
            "ja": "単語「здание」は-иеで終わるため、中性名詞です。形容詞も中性形（новое）にする必要があります。",
            "vi": "Từ 'здание' kết thúc bằng -ие, nghĩa là nó thuộc giống trung. Tính từ phải ở giống trung ('новое').",
            "zh": "单词“здание”以-ие结尾，这意味着它是中性的。形容词必须是中性的（“новое”）。"
        }
    }
]
