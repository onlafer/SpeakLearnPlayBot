ODD_ONE_OUT_QUESTIONS = [
    # --- LEVEL A1 ---
    {
        ...
        "explanation": {
            ...
            "fa": "شغل، بقیه اعضای خانواده هستند.",
            "ja": "職業。他は家族のメンバーです。",
            "vi": "Nghề nghiệp, những từ còn lại là thành viên gia đình.",
            "zh": "职业，其他是家庭成员。"
        }
    },
    {
        "level": "a1",
        "words": ["Яблоко", "банан", "апельсин", "хлеб"],
        "correct_answer": "хлеб",
        "explanation": {
            ...
            "fa": "نان، بقیه میوه هستند.",
            "ja": "パン製品。他は果物です。",
            "vi": "Sản phẩm bánh mì, những từ còn lại là trái cây.",
            "zh": "面食，其他是水果。"
        }
    },
    {
        "level": "a1",
        "words": ["Красный", "синий", "зелёный", "книга"],
        ...
        "explanation": {
            ...
            "fa": "شیء، بقیه رنگ هستند.",
            "ja": "物。他は色です。",
            "vi": "Đồ vật, những từ còn lại là màu sắc.",
            "zh": "物品，其他是颜色。"
        }
    },
    {
        "level": "a1",
        "words": ["Стол", "стул", "кровать", "метро"],
        ...
        "explanation": {
            ...
            "fa": "حمل و نقل، بقیه مبلمان هستند.",
            "ja": "交通機関。他は家具です。",
            "vi": "Giao thông, những từ còn lại là nội thất.",
            "zh": "交通工具，其他是家具。"
        }
    },
    {
        "level": "a1",
        "words": ["Читать", "писать", "слушать", "завтрак"],
        ...
        "explanation": {
            ...
            "fa": "اسم/وعده غذایی، بقیه فعل هستند.",
            "ja": "名詞/食事。他は動詞です。",
            "vi": "Danh từ/Bữa ăn, những từ còn lại là động từ.",
            "zh": "名词/早餐，其他是动词。"
        }
    },
    {
        "level": "a1",
        "words": ["Кошка", "собака", "лошадь", "окно"],
        "correct_answer": "окно",
        "explanation": {
            ...
            "fa": "شیء بی‌جان، بقیه حیوان هستند.",
            "ja": "無生物。他は動物です。",
            "vi": "Vật vô tri, những từ còn lại là động vật.",
            "zh": "无生命物体，其他是动物。"
        }
    },
    {
        "level": "a1",
        "words": ["Понедельник", "среда", "суббота", "утро"],
        "correct_answer": "утро",
        "explanation": {
            ...
            "fa": "زمان روز، بقیه روزهای هفته هستند.",
            "ja": "時間帯。他は曜日です。",
            "vi": "Thời điểm trong ngày, những từ còn lại là các thứ trong tuần.",
            "zh": "一天中的某个时段，其他是星期。"
        }
    },
    {
        "level": "a1",
        "words": ["Шапка", "куртка", "шарф", "холодно"],
        ...
        "explanation": {
            ...
            "fa": "قید/وضعیت، بقیه لباس هستند.",
            "ja": "副詞/状態。他は衣類です。",
            "vi": "Trạng từ/Trạng thái, những từ còn lại là quần áo.",
            "zh": "副词/状态，其他是衣服。"
        }
    },
    {
        "level": "a1",
        "words": ["Чай", "кофе", "вода", "тарелка"],
        ...
        "explanation": {
            ...
            "fa": "ظرف، بقیه نوشیدنی هستند.",
            "ja": "食器。他は飲み物です。",
            "vi": "Bát đĩa, những từ còn lại là đồ uống.",
            "zh": "餐具，其他是饮料。"
        }
    },
    {
        "level": "a1",
        "words": ["Москва", "Берлин", "Париж", "Россия"],
        ...
        "explanation": {
            ...
            "fa": "کشور، بقیه شهر هستند.",
            "ja": "国。他は都市です。",
            "vi": "Quốc gia, những từ còn lại là thành phố.",
            "zh": "国家，其他是城市。"
        }
    },
    ...
    {
        "level": "a2",
        "words": ["Поезд", "самолёт", "трамвай", "велосипедист"],
        ...
        "explanation": {
            ...
            "fa": "شخص، بقیه وسایل نقلیه هستند.",
            "ja": "人。他は乗り物です。",
            "vi": "Một người, những từ còn lại là phương tiện.",
            "zh": "一个人，其他是交通工具。"
        }
    },
    {
        "level": "a2",
        "words": ["Рука", "нога", "голова", "очки"],
        "correct_answer": "очки",
        "explanation": {
            ...
            "fa": "لوازم جانبی، بقیه اعضای بدن هستند.",
            "ja": "アクセサリー。他は体の一部です。",
            "vi": "Phụ kiện, những từ còn lại là bộ phận cơ thể.",
            "zh": "配件，其他是身体部位。"
        }
    },
    {
        "level": "a2",
        "words": ["Тарелка", "вилка", "ложка", "кофе"],
        "correct_answer": "кофе",
        "explanation": {
            ...
            "fa": "نوشیدنی، بقیه وسایل آشپزخانه هستند.",
            "ja": "飲み物。他は調理器具です。",
            "vi": "Đồ uống, những từ còn lại là dụng cụ nhà bếp.",
            "zh": "饮料，其他是厨具。"
        }
    },
    {
        "level": "a2",
        "words": ["Весна", "осень", "лето", "январь"],
        ...
        "explanation": {
            ...
            "fa": "ماه، بقیه فصل هستند.",
            "ja": "月。他は季節です。",
            "vi": "Tháng, những từ còn lại là các mùa.",
            "zh": "月份，其他是季节。"
        }
    },
    {
        "level": "a2",
        "words": ["Учитель", "инженер", "повар", "работа"],
        ...
        "explanation": {
            ...
            "fa": "مفهوم انتزاعی، بقیه شغل هستند.",
            "ja": "抽象的な概念。他は職業です。",
            "vi": "Khái niệm trừu tượng, những từ còn lại là nghề nghiệp.",
            "zh": "抽象概念，其他是职业。"
        }
    },
    {
        "level": "a2",
        "words": ["Гора", "река", "озеро", "город"],
        ...
        "explanation": {
            ...
            "fa": "ساخته دست انسان، بقیه طبیعت هستند.",
            "ja": "人工物。他は自然です。",
            "vi": "Vật do con người tạo ra, những từ còn lại là thiên nhiên.",
            "zh": "人造物体，其他是大自然。"
        }
    },
    {
        "level": "a2",
        "words": ["Весёлый", "грустный", "злой", "умный"],
        ...
        "explanation": {
            ...
            "fa": "ویژگی شخصیتی، بقیه احساسات هستند.",
            "ja": "性格の特徴。他は感情/気分です。",
            "vi": "Đặc điểm tính cách, những từ còn lại là cảm xúc/tâm trạng.",
            "zh": "性格特征，其他是情绪/心情。"
        }
    },
    {
        "level": "a2",
        "words": ["Час", "минута", "секунда", "вчера"],
        ...
        "explanation": {
            ...
            "fa": "قید زمان، بقیه واحدهای زمانی هستند.",
            "ja": "時の副詞。他は時間の単位です。",
            "vi": "Trạng từ chỉ thời gian, những từ còn lại là đơn vị thời gian.",
            "zh": "时间副词，其他是时间单位。"
        }
    },
    {
        "level": "a2",
        "words": ["Шкаф", "диван", "полка", "стена"],
        ...
        "explanation": {
            ...
            "fa": "بخشی از ساختمان، بقیه مبلمان هستند.",
            "ja": "建物の一部。他は家具です。",
            "vi": "Một phần của tòa nhà, những từ còn lại là nội thất.",
            "zh": "建筑的一部分，其他是家具。"
        }
    },
    {
        "level": "a2",
        "words": ["Дождь", "снег", "туман", "зонт"],
        "correct_answer": "зонт",
        "explanation": {
            ...
            "fa": "شیء، بقیه پدیده‌های آب و هوایی هستند.",
            "ja": "物。他は気象現象です。",
            "vi": "Đồ vật, những từ còn lại là hiện tượng thời tiết.",
            "zh": "物品，其他是天气现象。"
        }
    },
    ...
    {
        "level": "b1",
        "words": ["Смелость", "честность", "доброта", "красота"],
        ...
        "explanation": {
            ...
            "fa": "ویژگی ظاهری، بقیه ویژگی‌های اخلاقی هستند.",
            "ja": "外見的な質。他は道徳的/内面的な特徴です。",
            "vi": "Phẩm chất bên ngoài, những từ còn lại là đặc điểm đạo đức/bên trong.",
            "zh": "外在品质，其他是道德/内在特征。"
        }
    },
    {
        "level": "b1",
        "words": ["Инфляция", "налоги", "бюджет", "скидка"],
        ...
        "explanation": {
            ...
            "fa": "اصطلاح خرده‌فروشی، بقیه اقتصاد کلان هستند.",
            "ja": "小売用語。他はマクロ経済学です。",
            "vi": "Thuật ngữ bán lẻ, những từ còn lại là kinh tế vĩ mô.",
            "zh": "零售术语，其他是宏观经济学。"
        }
    },
    {
        "level": "b1",
        "words": ["Гипотеза", "анализ", "эксперимент", "мнение"],
        ...
        "explanation": {
            ...
            "fa": "قضاوت ذهنی، بقیه فرآیندهای علمی هستند.",
            "ja": "主観的な判断。他は科学的プロセスです。",
            "vi": "Phán đoán chủ quan, những từ còn lại là quy trình khoa học.",
            "zh": "主观判断，其他是科学过程。"
        }
    },
    {
        "level": "b1",
        "words": ["Газета", "журнал", "сайт", "информация"],
        ...
        "explanation": {
            ...
            "fa": "محتوا، بقیه رسانه‌ها هستند.",
            "ja": "内容。他はメディア媒体です。",
            "vi": "Nội dung, những từ còn lại là phương tiện truyền thông.",
            "zh": "内容，其他是媒体载体。"
        }
    },
    {
        "level": "b1",
        "words": ["Роман", "рассказ", "пьеса", "читатель"],
        ...
        "explanation": {
            ...
            "fa": "شخص، بقیه ژانرهای ادبی هستند.",
            "ja": "人。他は文学ジャンルです。",
            "vi": "Người, những từ còn lại là thể loại văn học.",
            "zh": "人，其他是文学体裁。"
        }
    },
    {
        "level": "b1",
        "words": ["Выборы", "закон", "парламент", "сосед"],
        ...
        "explanation": {
            ...
            "fa": "شخص عادی، بقیه اصطلاحات سیاسی هستند.",
            "ja": "個人。他は政治用語です。",
            "vi": "Cá nhân, những từ còn lại là thuật ngữ chính trị.",
            "zh": "个人，其他是政治术语。"
        }
    },
    {
        "level": "b1",
        "words": ["Думать", "размышлять", "соображать", "забывать"],
        ...
        "explanation": {
            ...
            "fa": "متضاد فرآیندهای فکری.",
            "ja": "思考プロセスの対義語。",
            "vi": "Từ trái nghĩa với quá trình tư duy.",
            "zh": "思考过程的反义词。"
        }
    },
    {
        "level": "b1",
        "words": ["Кирпич", "бетон", "цемент", "здание"],
        ...
        "explanation": {
            ...
            "fa": "سازه نهایی، بقیه مصالح ساختمانی هستند.",
            "ja": "最終的な構造物。他は建築資材です。",
            "vi": "Cấu trúc hoàn thiện, những từ còn lại là vật liệu xây dựng.",
            "zh": "最终建筑，其他是建筑材料。"
        }
    },
    {
        "level": "b1",
        "words": ["Жажда", "голод", "усталость", "радость"],
        ...
        "explanation": {
            ...
            "fa": "احساس، بقیه حالت‌های فیزیولوژیک هستند.",
            "ja": "感情。他は生理的な状態です。",
            "vi": "Cảm xúc, những từ còn lại là trạng thái sinh lý.",
            "zh": "情绪，其他是生理状态。"
        }
    },
    {
        "level": "b1",
        "words": ["Диалог", "дискуссия", "спор", "тишина"],
        ...
        "explanation": {
            ...
            "fa": "عدم ارتباط، بقیه انواع تعامل هستند.",
            "ja": "コミュニケーションの欠如。他は相互作用の形です。",
            "vi": "Sự thiếu giao tiếp, những từ còn lại là các loại hình tương tác.",
            "zh": "缺乏交流，其他是互动的形式。"
        }
    }
]